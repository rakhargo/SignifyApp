...
import '../../../components/unavailable.dart'; // Import file unavailable.dart
...
class _GuideDetailState extends State<GuideDetail> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DetailPage(
          index: index,
          title: 'Detail Gerakan Isyarat ${index + 1}',
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    List<String> cardTitles = [
      // 'Panduan Aplikasi Signify',
      'Panduan Memahami Bahasa Isyarat',
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Yuk Baca Panduan Pengunaan Aplikasinya',
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
